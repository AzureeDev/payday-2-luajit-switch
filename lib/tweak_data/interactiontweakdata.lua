...
function InteractionTweakData:init(tweak_data)
	...
	if SystemInfo:platform() == Idstring("NX64") then
		self.pick_lock_easy.rumble_start = "lock_picking"
		self.pick_lock_easy.rumble_done = "lock_picking_true"
		self.pick_lock_easy.rumble_random_loop = "lock_picking_false"
		self.pick_lock_easy.rumble_random_loop_length = {
			300,
			1000
		}
		self.pick_lock_easy.rumble_random_loop_delay = {
			500,
			1500
		}
	end
	...
	if SystemInfo:platform() == Idstring("NX64") then
		self.pick_lock_easy_no_skill.rumble_start = "lock_picking"
		self.pick_lock_easy_no_skill.rumble_done = "lock_picking_true"
		self.pick_lock_easy_no_skill.rumble_random_loop = "lock_picking_false"
		self.pick_lock_easy_no_skill.rumble_random_loop_length = {
			300,
			1000
		}
		self.pick_lock_easy_no_skill.rumble_random_loop_delay = {
			500,
			1500
		}
	end
	...
	if SystemInfo:platform() == Idstring("NX64") then
		self.pick_lock_hard.rumble_start = "lock_picking"
		self.pick_lock_hard.rumble_done = "lock_picking_true"
		self.pick_lock_hard.rumble_random_loop = "lock_picking_false"
		self.pick_lock_hard.rumble_random_loop_length = {
			300,
			1000
		}
		self.pick_lock_hard.rumble_random_loop_delay = {
			500,
			1500
		}
	end
	...
	if SystemInfo:platform() == Idstring("NX64") then
		self.pick_lock_hard_no_skill.rumble_start = "lock_picking"
		self.pick_lock_hard_no_skill.rumble_done = "lock_picking_true"
		self.pick_lock_hard_no_skill.rumble_random_loop = "lock_picking_false"
		self.pick_lock_hard_no_skill.rumble_random_loop_length = {
			300,
			1000
		}
		self.pick_lock_hard_no_skill.rumble_random_loop_delay = {
			500,
			1500
		}
	end
	...
	if SystemInfo:platform() == Idstring("NX64") then
		self.pick_lock_deposit_transport.rumble_start = "lock_picking"
		self.pick_lock_deposit_transport.rumble_done = "lock_picking_true"
		self.pick_lock_deposit_transport.rumble_random_loop = "lock_picking_false"
		self.pick_lock_deposit_transport.rumble_random_loop_length = {
			300,
			1000
		}
		self.pick_lock_deposit_transport.rumble_random_loop_delay = {
			500,
			1500
		}
	end
	...
	if SystemInfo:platform() == Idstring("NX64") then
		self.open_door_with_keys.rumble_start = "lock_picking"
		self.open_door_with_keys.rumble_done = "lock_picking_true"
		self.open_door_with_keys.rumble_random_loop = "lock_picking_false"
		self.open_door_with_keys.rumble_random_loop_length = {
			300,
			1000
		}
		self.open_door_with_keys.rumble_random_loop_delay = {
			500,
			1500
		}
	end
	...
	if SystemInfo:platform() == Idstring("NX64") then
		self.drill.rumble_start = "place_drill"
		self.drill.rumble_done = "drill_activate"
	end
	...
	if SystemInfo:platform() == Idstring("NX64") then
		self.drill_upgrade.rumble_done = "drill_activate"
	end
	...
	if SystemInfo:platform() == Idstring("NX64") then
		self.drill_jammed.rumble_start = "place_drill"
		self.drill_jammed.rumble_done = "drill_activate"
	end
	...
	if SystemInfo:platform() == Idstring("NX64") then
		self.lance.rumble_start = "place_drill"
		self.lance.rumble_done = "drill_activate"
	end
	...
	if SystemInfo:platform() == Idstring("NX64") then
		self.lance_jammed.rumble_start = "place_drill"
		self.lance_jammed.rumble_done = "drill_activate"
	end
	...
	if SystemInfo:platform() == Idstring("NX64") then
		self.lance_upgrade.rumble_done = "drill_activate"
	end
	...
	if SystemInfo:platform() == Idstring("NX64") then
		self.apartment_drill.rumble_start = "place_drill"
		self.apartment_drill.rumble_done = "drill_activate"
	end
	...
	if SystemInfo:platform() == Idstring("NX64") then
		self.apartment_drill_jammed.rumble_start = "place_drill"
		self.apartment_drill_jammed.rumble_done = "drill_activate"
	end
	...
	if SystemInfo:platform() == Idstring("NX64") then
		self.suburbia_drill.rumble_start = "place_drill"
		self.suburbia_drill.rumble_done = "drill_activate"
	end
	...
	if SystemInfo:platform() == Idstring("NX64") then
		self.suburbia_drill_jammed.rumble_start = "place_drill"
		self.suburbia_drill_jammed.rumble_done = "drill_activate"
	end
	...
	if SystemInfo:platform() == Idstring("NX64") then
		self.goldheist_drill.rumble_start = "place_drill"
		self.goldheist_drill.rumble_done = "drill_activate"
	end
	...
	if SystemInfo:platform() == Idstring("NX64") then
		self.goldheist_drill_jammed.rumble_start = "place_drill"
		self.goldheist_drill_jammed.rumble_done = "drill_activate"
	end
	...
	if SystemInfo:platform() == Idstring("NX64") then
		self.stash_planks.rumble_start = "hammer_planks"
	end
	...
	if SystemInfo:platform() == Idstring("NX64") then
		self.lockpick_locker.rumble_start = "lock_picking"
		self.lockpick_locker.rumble_done = "lock_picking_true"
		self.lockpick_locker.rumble_random_loop = "lock_picking_false"
		self.lockpick_locker.rumble_random_loop_length = {
			300,
			1000
		}
		self.lockpick_locker.rumble_random_loop_delay = {
			500,
			1500
		}
	end
	...
	if SystemInfo:platform() == Idstring("NX64") then
		self.cas_fix_bfd_drill.rumble_start = "place_drill"
		self.cas_fix_bfd_drill.rumble_done = "drill_activate"
	end
	...
	if SystemInfo:platform() == Idstring("NX64") then
		self.pick_lock_30.rumble_start = "lock_picking"
		self.pick_lock_30.rumble_done = "lock_picking_true"
		self.pick_lock_30.rumble_random_loop = "lock_picking_false"
		self.pick_lock_30.rumble_random_loop_length = {
			300,
			1000
		}
		self.pick_lock_30.rumble_random_loop_delay = {
			500,
			1500
		}
	end
	...
	if SystemInfo:platform() == Idstring("NX64") then
		self.man_trunk_picklock.rumble_start = "lock_picking"
		self.man_trunk_picklock.rumble_done = "lock_picking_true"
		self.man_trunk_picklock.rumble_random_loop = "lock_picking_false"
		self.man_trunk_picklock.rumble_random_loop_length = {
			300,
			1000
		}
		self.man_trunk_picklock.rumble_random_loop_delay = {
			500,
			1500
		}
	end
