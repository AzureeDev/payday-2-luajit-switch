...
function NarrativeTweakData:init(tweak_data)
	...
	if platform == Idstring("XB1") or platform == Idstring("PS4") or platform == Idstring("NX64") then
	...
	self.jobs.short1 = {
		...
		switch_name_id = "heist_short1_nx64",
		switch_job_plan_id = "heist_short1_plan_nx64",
	...
	self.jobs.short2 = {
		...
		switch_name_id = "heist_short2_nx64",
		switch_job_plan_id = "heist_short2_plan_nx64",
