...
function TweakData:init()
	...
	self.screen_colors.button_stage_4 = self.screen_colors.button_stage_3

	if SystemInfo:platform() == Idstring("NX64") then
		self.screen_colors.button_stage_1 = Color(255, 255, 255, 255) / 255
		self.screen_colors.button_stage_4 = self.screen_colors.button_stage_1
	end
	...
	if SystemInfo:platform() == Idstring("NX64") then
		self.gui.PAUSE_COMPONENT_LAYER = 1022
	else
		self.gui.PAUSE_COMPONENT_LAYER = self.gui.MENU_COMPONENT_LAYER
	end
...
function TweakData:free_dlc_list()
	local free_dlcs = {
		...
		poetry_soundtrack = true,
		goty_heist_bundle_2014 = true,
		goty_weapon_bundle_2014 = true,
		goty_dlc_bundle_2014 = true,
		speedrunners = true,
		hlm_game = true,
		hlm2 = true,
		hlm2_deluxe = true,
...
function TweakData:set_menu_scale()
	...
	if SystemInfo:platform() == Idstring("NX64") then
		self.menu.switch_legend_button_scale_w = 1.6
		self.menu.switch_legend_button_scale_h = 1.45
	end
	...
	self.menu.main_menu_width = 460
	self.menu.main_menu_button_height = 120
	self.menu.main_play_menu_button_height = 164
	self.menu.main_crimenet_menu_button_height = 254
	self.menu.switch_reticle_button_height = 70
	self.menu.main_menu_padding = 14
	self.menu.slider_button_height = 83
	self.menu.slider_button_nx_bar_lift = 10
	self.menu.options_button_height = 42
	self.menu.crimenet_contract_buttons_height = 40
	self.menu.options_font_size = 28
	self.menu.scroll_bar_width = 20
	self.menu.options_multichoice_choice_font_size = 20
	self.menu.options_multichoice_text_font_size = 18
	self.menu.checkbox_padding = 5
	self.menu.unselected_color = Color(0.41, 0.55, 0.6)
	self.menu.unselected_alpha = 0.35
	self.menu.selected_color = Color(0, 0.69, 1)
	self.menu.selected_alpha = 0.5
	self.menu.disabled_color = Color(0.41, 0.55, 0.6)
	self.menu.disabled_alpha = 0.15
...
function TweakData:get_joycon_coords()
	if managers.controller:get_default_wrapper_type() == "pc" or managers.controller:get_default_wrapper_type() == "steam" then
		return false
	end
	...
	coords.normal.right_shoulder_1 = {
		vertical = "center",
		y = 136,
		id = "menu_button_shout_and_stop_1",
		align = "left",
		x = 512
	}
	coords.normal.right_shoulder_2 = {
		vertical = "top",
		y = 148,
		id = "menu_button_shout_and_stop_2",
		align = "left",
		x = 512
	}
	coords.normal.right_trigger = {
	...
	coords.normal.left_shoulder_1 = {
		vertical = "center",
		y = 136,
		id = "menu_button_deploy_1",
		align = "right",
		x = 0
	}
	coords.normal.left_shoulder_2 = {
		vertical = "top",
		y = 148,
		id = "menu_button_deploy_2",
		align = "right",
		x = 0
	}
	coords.normal.left_trigger = {
	...
	coords.normal.d_down_1 = {
		vertical = "bottom",
		y = 332,
		id = "menu_button_weapon_gadget_bipod_1",
		align = "right",
		x = 0
	}
	coords.normal.d_down_2 = {
		vertical = "top",
		y = 332,
		id = "menu_button_weapon_gadget_bipod_2",
		align = "right",
		x = 0
	}
	coords.normal.d_left = {
...
function TweakData:get_switch_pro_coords()
	if managers.controller:get_default_wrapper_type() == "pc" or managers.controller:get_default_wrapper_type() == "steam" then
		return false
	end
