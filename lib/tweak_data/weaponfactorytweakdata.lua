...
function WeaponFactoryTweakData:_init_installed_parts()
	local installed_weapons = {
		"wpn_fps_ass_ak5",
		"wpn_fps_ass_74",
		"wpn_fps_ass_akm",
		"wpn_fps_smg_akmsu",
	...
	for _, weapon in pairs(installed_weapons) do
		for _, mod in pairs(self[weapon].default_blueprint) do
			self.parts[mod].installed = true
		end
	end
end
