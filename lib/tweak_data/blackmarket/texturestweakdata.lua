...
function BlackMarketTweakData:_init_textures(tweak_data)
	...
	self.textures.no_color_no_material.installed = true
	self.textures.no_color_full_material.installed = true
	self.textures.big_skull.installed = true
	self.textures.eightball.installed = true
	self.textures.zebra.installed = true
	self.textures.overkill.installed = true
	self.textures.spawn.installed = true
	self.textures.marv.installed = true
	self.textures.starbreeze.installed = true
	self.textures.cobrakai.installed = true
	self.textures.flames.installed = true
	self.textures.tribal.installed = true
	self.textures.skull.installed = true
	self.textures.arrow.installed = true
	self.textures.usa.installed = true
	self.textures.unionjack.installed = true
	self.textures.fleur.installed = true
	self.textures.hearts.installed = true
	self.textures.electric.installed = true
	self.textures.puzzle.installed = true
	self.textures.swe_camo.installed = true
	self.textures.japan.installed = true
	self.textures.celtic1.installed = true
	self.textures.dragon_full.installed = true
	self.textures.dragon_split.installed = true
	self.textures.horizon_circle.installed = true
	self.textures.tribal2.installed = true
	self.textures.vertical.installed = true
	self.textures.celtic2.installed = true
	self.textures.beast.installed = true
	self.textures.headshot.installed = true
	self.textures.circuit.installed = true
	self.textures.paint1.installed = true
	self.textures.chains.installed = true
	self.textures.yinyang.installed = true
	self.textures.rorschach.installed = true
	self.textures.zipper.installed = true
	self.textures.daniel.installed = true
	self.textures.ouroboros.installed = true
	self.textures.ouro.installed = true
	self.textures.cat.installed = true
	self.textures.clown.installed = true
	self.textures.paint2.installed = true
	self.textures.spider.installed = true
	self.textures.target.installed = true
	self.textures.illuminati.installed = true
	self.textures.hypnotic.installed = true
	self.textures.hexagon.installed = true
	self.textures.messatsu.installed = true
	self.textures.shazam.installed = true
	self.textures.emblem1.installed = true
	self.textures.emblem2.installed = true
	self.textures.emblem3.installed = true
	self.textures.swirl.installed = true
	self.textures.kabuki1.installed = true
	self.textures.ultimaterobber.installed = true
	self.textures.nuclear.installed = true
	self.textures.gearhead.installed = true
	self.textures.atom.installed = true
	self.textures.hand.installed = true
	self.textures.scars.installed = true
	self.textures.pirate.installed = true
	self.textures.foot.installed = true
	self.textures.star.installed = true
	self.textures.portal.installed = true
	self.textures.aperture.installed = true
	self.textures.girlsandboys.installed = true
	self.textures.loverboy.installed = true
	self.textures.cogs.installed = true
	self.textures.ace.installed = true
	self.textures.compass.installed = true
	self.textures.fan.installed = true
	self.textures.pd2.installed = true
	self.textures.fingerprint.installed = true
	self.textures.biohazard.installed = true
	self.textures.tf2.installed = true
	self.textures.cake.installed = true
	self.textures.companioncube.installed = true
	self.textures.two.installed = true
	self.textures.striped.installed = true
	self.textures.solidfirst.installed = true
	self.textures.solidsecond.installed = true
	self.textures.mantis.installed = true
	self.textures.bite.installed = true
	self.textures.wtf.installed = true
	self.textures.bloodsucker.installed = true
	self.textures.hawk.installed = true
	self.textures.magnet.installed = true
	self.textures.diamond.installed = true
	self.textures.luchador.installed = true
	self.textures.maskedfalcon.installed = true
	self.textures.grayson.installed = true
	self.textures.sidestripe.installed = true
	self.textures.gradient.installed = true
	self.textures.spikes.installed = true
	self.textures.barbarian.installed = true
	self.textures.reaper.installed = true
	self.textures.whiner.installed = true
	self.textures.emblem4.installed = true
	self.textures.daft_heart.installed = true
	self.textures.anarchy.installed = true
	self.textures.molecule.installed = true
	self.textures.fleur2.installed = true
	self.textures.trekronor.installed = true
	self.textures.raster.installed = true
	self.textures.flag.installed = true
	self.textures.cracker.installed = true
	self.textures.hellish.installed = true
	self.textures.poison.installed = true
	self.textures.yggdrasil.installed = true
