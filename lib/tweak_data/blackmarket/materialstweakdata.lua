function BlackMarketTweakData:_init_materials(tweak_data)
	...
	self.materials.plastic.installed = true
	self.materials.titanium.installed = true
	self.materials.mercury.installed = true
	self.materials.oxide_bronze.installed = true
	self.materials.deep_bronze.installed = true
	self.materials.slime.installed = true
	self.materials.gold_clean.installed = true
	self.materials.concrete1.installed = true
	self.materials.rock1.installed = true
	self.materials.rock2.installed = true
	self.materials.rock3.installed = true
	self.materials.whiterock.installed = true
	self.materials.metal1.installed = true
	self.materials.cracks1.installed = true
	self.materials.wicker1.installed = true
	self.materials.scales.installed = true
	self.materials.oldbronze.installed = true
	self.materials.bark1.installed = true
	self.materials.bark2.installed = true
	self.materials.bark3.installed = true
	self.materials.carbon.installed = true
	self.materials.leather.installed = true
	self.materials.bloodred.installed = true
	self.materials.waterblue.installed = true
	self.materials.matteblack.installed = true
	self.materials.pianoblack.installed = true
	self.materials.twoblue.installed = true
	self.materials.rainbow.installed = true
	self.materials.magma.installed = true
	self.materials.radioactive.installed = true
	self.materials.bismuth.installed = true
	self.materials.greygloss.installed = true
	self.materials.finewood.installed = true
	self.materials.skin.installed = true
	self.materials.alligator.installed = true
	self.materials.denim.installed = true
	self.materials.candy.installed = true
	self.materials.chrome_purple.installed = true
	self.materials.hot_cold.installed = true
	self.materials.orchish.installed = true
