...
function NewFlamethrowerBase:start_shooting(...)
	NewFlamethrowerBase.super.start_shooting(self, ...)

	self.fire_rumble = managers.rumble:play("weapon_fire_flamethrower", nil, 0.8, nil, 0)
end

function NewFlamethrowerBase:stop_shooting(...)
	NewFlamethrowerBase.super.stop_shooting(self, ...)
	managers.rumble:stop(self.fire_rumble)
end
