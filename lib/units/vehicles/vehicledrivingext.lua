...
function VehicleDrivingExt:init(unit)
	...
	self._old_position = Vector3(0, 0, -10000)
...
function VehicleDrivingExt:_wake_nearby_dynamics()
	local vehicle_position = self._vehicle:position()
	local position_dt = vehicle_position - self._old_position

	if position_dt:length() < 2.5 then
		return
	end

	self._old_position = vehicle_position
