...
function MissionEndState:on_statistics_result(best_kills_peer_id, best_kills_score, best_special_kills_peer_id, best_special_kills_score, best_accuracy_peer_id, best_accuracy_score, most_downs_peer_id, most_downs_score, total_kills, total_specials_kills, total_head_shots, group_accuracy, group_downs)
	...
	if managers.network and managers.network:session() then
		...
		local best_kills = "N/A"
		local best_special_kills = "N/A"
		local best_accuracy = "N/A"
		local most_downs = "N/A"

		if SystemInfo:platform() == Idstring("NX64") then
			best_kills = best_kills_peer and best_kills_peer:xuid() or "N/A"
			best_special_kills = best_special_kills_peer and best_special_kills_peer:xuid() or "N/A"
			best_accuracy = best_accuracy_peer and best_accuracy_peer:xuid() or "N/A"
			most_downs = most_downs_peer and most_downs_peer:xuid() or "N/A"
		else
			best_kills = best_kills_peer and best_kills_peer:name() or "N/A"
			best_special_kills = best_special_kills_peer and best_special_kills_peer:name() or "N/A"
			best_accuracy = best_accuracy_peer and best_accuracy_peer:name() or "N/A"
			most_downs = most_downs_peer and most_downs_peer:name() or "N/A"
		end
