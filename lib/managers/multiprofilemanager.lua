...
function MultiProfileManager:current_profile_name()
	...
	local title_string = "menu_player_inventory_new"
	local text = managers.localization:to_upper_text(title_string)

	return self:current_profile().name or text .. " " .. self._global._current_profile
end
