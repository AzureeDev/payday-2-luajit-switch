...
function MenuNodeUpdatesGui:setup()
	...
	back_button:set_visible(managers.menu:is_pc_controller() or managers.menu:is_switch_controller())
	...
	if MenuBackdropGUI then
		...
		if managers.menu:is_pc_controller() or managers.menu:is_switch_controller() then
	...
	if num_previous_updates < #content_updates then
		...
		local prev_button = managers.menu:is_steam_controller() and managers.localization:steam_btn("bumper_l") or (managers.menu:is_pc_controller() or managers.menu:is_switch_controller()) and "<" or managers.localization:get_default_macro("BTN_BOTTOM_L")
		local next_button = managers.menu:is_steam_controller() and managers.localization:steam_btn("bumper_r") or (managers.menu:is_pc_controller() or managers.menu:is_switch_controller()) and ">" or managers.localization:get_default_macro("BTN_BOTTOM_R")
