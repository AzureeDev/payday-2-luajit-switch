...
function MenuGuiComponentGeneric:_add_back_button()
	...
	self._panel:child("back_button"):set_visible(managers.menu:is_pc_controller() or managers.menu:is_switch_controller())

	if MenuBackdropGUI and (managers.menu:is_pc_controller() or managers.menu:is_switch_controller()) then
