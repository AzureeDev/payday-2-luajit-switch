...
require("lib/network/matchmaking/NetworkAccountNX64")
...
require("lib/network/matchmaking/NetworkFriendsNX64")
...
require("lib/network/matchmaking/NetworkMatchMakingNX64")
...
if SystemInfo:platform() == Idstring("X360") or SystemInfo:platform() == Idstring("PS3") or SystemInfo:platform() == Idstring("NX64") or SystemInfo:platform() == Idstring("PS4") or SystemInfo:platform() == Idstring("XB1") then
...
function NetworkManager:init()
	...
	elseif self._is_nx64 then
		self.account = NetworkAccountNX64:new()
...
function NetworkManager:_create_lobby()
	...
	elseif self._is_nx64 then
		self.friends = NetworkFriendsNX64:new()
		self.matchmake = NetworkMatchMakingNX64:new()
...
function NetworkManager:NX64_determine_voice(lan)
end
