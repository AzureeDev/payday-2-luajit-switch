...
function Manager:on_press_rumble()
end

function Manager:on_move_rumble()
end

function Manager:on_slider_press_rumble(touch)
end

function Manager:update_slider_rumble(value, touch)
end

function Manager:stop_slider_rumble(touch)
end
