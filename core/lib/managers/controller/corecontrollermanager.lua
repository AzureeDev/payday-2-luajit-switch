...
core:import("CoreControllerWrapperNX64")
...
function ControllerManager:init(path, default_settings_path)
	...
	elseif SystemInfo:platform() == Idstring("NX64") then
		self._supported_wrapper_types[CoreControllerWrapperNX64.ControllerWrapperNX64.TYPE] = CoreControllerWrapperNX64.ControllerWrapperNX64
